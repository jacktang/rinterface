...
describe "Rinterface" do
  ...
  describe "Numbers" do
    ...
    it "should work small ints" do
      r = Erlang::Node.rpc("spec","spec_server", "echo", 99)
      r.should eql([:ok, 99])
    end
    ...
    it "should work small ints 8bits" do
      r = Erlang::Node.rpc("spec","spec_server", "echo", 255)
      r.should eql([:ok, 255])
    end
    ...
    it "should work with floats" do
      r = Erlang::Node.rpc("spec","spec_server", "echo", 0.005)
      r.should eql([:ok, 0.005])
      r[1].should be_instance_of(Float)
    end

    it "should work with negative floats" do
      r = Erlang::Node.rpc("spec","spec_server", "echo", -0.5)
      r.should eql([:ok, -0.5])
      r[1].should be_instance_of(Float)
    end

    it "should work with floats" do
      r = Erlang::Node.rpc("spec","spec_server", "echo", 1234.5)
      r.should eql([:ok, 1234.5])
    end

    it "should work with floats" do
      r = Erlang::Node.rpc("spec","spec_server", "echo", 1234.59999)
  ...
  describe "Strings" do
    ...
    it "should work with strings" do
      r = Erlang::Node.rpc("spec","spec_server", "echo", "ping")
      r.should eql([:ok, "ping"])
    end

    it "should work with strange chars I" do
      r = Erlang::Node.rpc("spec","spec_server", "echo", "($)[&]{@}")
      r.should be_ok_with("($)[&]{@}")
    end
